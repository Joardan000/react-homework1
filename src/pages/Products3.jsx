...
function Products() {
    ...
    const mapData = product.map((a) => (
        <div className="cursor-pointer hover:shadow-lg max-w-[264px] max-[650px]:max-w-[400px] anime3 p-3 hover:max-w-[350px] flex justify-center mx-auto w-full transition-all duration-300 ease-in-out bg-gray-200 rounded-lg"
             key={a.id}>
            <div>
