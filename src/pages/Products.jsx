...
function Products() {
    ...
    const mapData = product.map((a) => (
        <div className="cursor-pointer hover:shadow-lg max-w-[264px] max-[650px]:max-w-[400px] anime p-3 hover:max-w-[350px] flex justify-center mx-auto w-full transition-all duration-300 ease-in-out bg-white rounded-lg"
            key={a.id}>
            <div>
    ...
    return (
        <>
            <section className="max-w-[1240px] mx-auto w-full m-10">
                ...
                <div className="flex justify-center max-[650px]:grid max-[500px]:grid-cols-1 flex-wrap gap-x-5 gap-y-8 mb-[52px]">{mapData}</div>
                <div className="px-3">
